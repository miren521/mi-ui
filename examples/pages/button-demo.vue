		...
		<view class="m-button-demo__container">
			...
			<demo-block title="图标尺寸" desc="通过 icon-size 属性自定义图标大小">
				...
				<view class="demo-button-row" style="margin-top: 20rpx">
					...
					<m-button icon="star" type="success" icon-size="20px" class="fit-content-btn"></m-button>
					<m-button icon="star" type="success" icon-size="28px" class="fit-content-btn"></m-button>
					<m-button icon="star" type="success" icon-size="36px" class="fit-content-btn"></m-button>
				</view>
			</demo-block>
