...
export const formComponents: ComponentItem[] = [
  ...
  { id: 'search', title: 'Search 搜索框', enTitle: 'Search', zhTitle: '搜索框', desc: '搜索框组件，支持多种样式变体和事件监听', category: 'form', url: '/examples/pages/search-demo' },
...
export const navigationComponents: ComponentItem[] = [
  ...
  { id: 'fab', title: 'Fab 浮动按钮', enTitle: 'Fab', zhTitle: '浮动按钮', desc: '浮动操作按钮组件，支持展开菜单、拖动、位置定制', category: 'navigation', url: '/examples/pages/fab-demo' },
]
