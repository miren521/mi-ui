<template>
  ...
  >
    ...
    <m-transition
      v-if="expandable"
      :enter-class="`m-fab__transition-enter--${fabDirection}`"
      enter-active-class="m-fab__transition-enter-active"
      :leave-to-class="`m-fab__transition-leave-to--${fabDirection}`"
      leave-active-class="m-fab__transition-leave-active"
      :custom-class="`m-fab__actions m-fab__actions--${fabDirection}`"
      :show="isActive"
      :duration="300"
    >
      <slot></slot>
