...
/**
 * 头像状态类型
 * 可选值: 'online' | 'offline' | 'busy' | 'vip'
 */
export type AvatarStatus = 'online' | 'offline' | 'busy' | 'vip'
...
export const avatarProps = {
  ...
  /**
   * 状态徽标位置
   * 类型: 'top-right' | 'bottom-right'
   * 可选值: 'top-right' | 'bottom-right'
   * 默认值: 'top-right'
   */
  statusPosition: makeStringProp<'top-right' | 'bottom-right'>('top-right')
}
