...
const now = new Date()
const defaultMinDate = new Date(now.getFullYear() - 1, now.getMonth(), now.getDate()).getTime()
const defaultMaxDate = new Date(now.getFullYear() + 1, now.getMonth(), now.getDate(), 23, 59, 59).getTime()
